...
def run():
    ...
    try:
        ...
        dim_date.to_parquet(GOLD_DIR / "dim_date.parquet")
    ...
    try:
        ...
        step = "SAVE"
        logging.info(f"{layer} | {domain} | {step} | {table} | target=parquet")
        dim_payment_mode.to_parquet(GOLD_DIR / "dim_payment_mode.parquet")
    ...
    try:
        ...
        step = "SAVE"
        logging.info(f"{layer} | {domain} | {step} | {table} | target=parquet")
        dim_order_status.to_parquet(GOLD_DIR / "dim_order_status.parquet")
    ...
    try:
        ...
        step = "SAVE"
        logging.info(f"{layer} | {domain} | {step} | {table} | target=parquet")
        dim_restaurants.to_parquet(GOLD_DIR / "dim_restaurants.parquet")
    ...
    try:
        ...
        step = "SAVE"
        logging.info(f"{layer} | {domain} | {step} | {table} | target=parquet")
        dim_employees.to_parquet(GOLD_DIR / "dim_employees.parquet")
    ...
    try:
        ...
        step = "SAVE"
        logging.info(f"{layer} | {domain} | {step} | {table} | target=parquet")
        dim_customers.to_parquet(GOLD_DIR / "dim_customers.parquet")
    ...
    try:
        ...
        step = "SAVE"
        logging.info(f"{layer} | {domain} | {step} | {table} | target=parquet")
        dim_menu_items.to_parquet(GOLD_DIR / "dim_menu_items.parquet")
    ...
    try:
        ...
        step = "SAVE"
        logging.info(f"{layer} | {domain} | {step} | {table} | target=parquet")
        dim_delivery_partners.to_parquet(GOLD_DIR / "dim_delivery_partners.parquet")
    ...
    try:
        ...
        step = "SAVE"
        logging.info(f"{layer} | {domain} | {step} | {table} | target=parquet")
        fact_sales.to_parquet(GOLD_DIR / "fact_sales.parquet")
